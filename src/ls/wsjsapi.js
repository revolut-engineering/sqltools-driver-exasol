// Copied from https://github.com/exasol/websocket-api/blob/master/javascript/wsjsapi.js
// Updated and fixed
...
var Exasol = function(url, user, pass, onconnect, onerror, websocketConfig) {
    ...
    context.com = function(request, onresponse, onerror) {
        ...
        if (context.inwork === true) {
            console.log('Connection already in work, bailing');
        ...
        context.connection.onmessage = function(repdata) {
            ...
            try {
                ...
                const rep = json_parse(repdata.data);
                if (rep['status'] == 'ok') {
